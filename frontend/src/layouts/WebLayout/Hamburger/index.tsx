...
export function Hamburger() {
  ...
  return (
    <Sheet>
      ...
      <SheetContent className='website flex flex-col items-start w-full max-w-[18rem] sm:max-w-[18rem] lg:max-w-[18rem] bg-background px-3 py-10 overflow-y-auto'>
        ...
        <nav className='mt-[3rem]'>
          <ul className='flex flex-col justify-start gap-3'>
            <li className='flex'>
              <SheetClose asChild>
                <Button asChild variant='ghost' size='tiny' className={`flex h-7 pl-5 text-base text-primary relative hover:text-secondary hover:after:absolute after:inset-y-0 after:left-0 after:w-1 after:rounded-r-lg after:bg-secondary 
        ...
        <button className='flex items-center gap-2 mt-[2rem] pl-4'>
          ...
          <div className='flex flex-col items-start'>
            <span className='font-normal leading-none text-[90%] text-primary'>Programação em</span>
            <span className='leading-normal text-primary'>Niterói</span>
          </div>
        </button>
